...
ROBERTA_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    'roberta-base-mnli': 'https://s3.amazonaws.com/models.huggingface.co/bert/roberta-large-mnli-config.json',
    "roberta-large-mnli": "https://s3.amazonaws.com/models.huggingface.co/bert/distilroberta-base-config.json",
    'roberta-base-sep': 'bert/roberta-base-config.json',
