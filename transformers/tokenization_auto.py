...
from .tokenization_roberta import RobertaTokenizer, RobertaTokenizerFast, RobertaTokenizerSeparatePair, RobertaTokenizerSeparatePairFast
...
TOKENIZER_MAPPING = OrderedDict(
    [
        ...
        # (RobertaConfig, (RobertaTokenizerSeparatePair, RobertaTokenizerSeparatePairFast)),
